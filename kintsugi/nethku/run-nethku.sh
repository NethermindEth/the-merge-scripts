...
services:
  ...
  teku:
    ...
    command: >
        --data-path "datadir-teku"   --network https://github.com/eth-clients/merge-testnets/raw/main/kintsugi/config.yaml   --initial-state https://github.com/eth-clients/merge-testnets/raw/main/kintsugi/genesis.ssz   --Xee-endpoint http://localhost:8550   --p2p-discovery-bootnodes "enr:-Iq4QKuNB_wHmWon7hv5HntHiSsyE1a6cUTK1aT7xDSU_hNTLW3R4mowUboCsqYoh1kN9v3ZoSu_WuvW9Aw0tQ0Dxv6GAXxQ7Nv5gmlkgnY0gmlwhLKAlv6Jc2VjcDI1NmsxoQK6S-Cii_KmfFdUJL2TANL3ksaKUnNXvTCv1tLwXs0QgIN1ZHCCIyk"
    network_mode: host
